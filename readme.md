...
The Obli Virtual Scheduler is an app designed to help people who are particularly
scatter-brained keep their obligations in order. It features a calendar that not
only keeps track of tasks, but will also auto-schedule events based on priority and
the time you have available. So, you can basically just input your todo items,
and it will find an optimal time for you to do them.
